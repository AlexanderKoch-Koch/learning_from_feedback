...
from learning_from_feedback.single_step_dreamer.dreamer_torch_policy import DreamerTorchPolicy
...
DEFAULT_CONFIG = with_common_config({
    ...
    # Grad Clipping
    "grad_clip": 100.0,
    "action_model_grad_clip": 100.0,
    "pred_model_grad_clip": 100.0,
    # Discount
    "discount": 0.99,
    # Lambda
    "lambda": 0.95,
    ...
    # Custom Model
    "dreamer_model": {
        "custom_model": SingleStepDreamer,
...
class EpisodicBuffer(object):
    ...
    def preprocess_episode(self, episode: SampleBatchType):
        ...
        action = episode["actions"][0:1]
        reward = episode["rewards"][0:1]
...
def execution_plan(workers, config):
    ...
    episode_buffer = EpisodicBuffer(max_length=config['buffer_size'], length=config["batch_length"])
